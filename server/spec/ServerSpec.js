...
describe('Node Server Request Listener Function', function() {
  it('Should answer GET requests for /1/classes/messages with a 200 status code', function() {
  ...
  it('Should accept posts to /1/classes/messages', function() {
    var stubMsg = {
      username: 'Jono',
      message: 'Do my bidding!'
    };
    var req = new stubs.request('/1/classes/messages', 'POST', stubMsg);
    var res = new stubs.response();
...
it('Should respond with messages that were previously posted', function() {
    ...
    req = new stubs.request('/1/classes/messages', 'GET');
